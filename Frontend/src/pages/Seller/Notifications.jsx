...
/* ─── DESIGN TOKENS (selaras dengan Home.jsx / BuyerNotifications.jsx) ── */
...
/* Map notif type ke icon + gradient warna (konteks seller) */
const TYPE_META = {
...
function Notifications() {
  ...
  // Group notifications by date bucket while preserving order
  const groups = [];
  let lastLabel = null;
      ...
      <main className="max-w-3xl mx-auto px-4 py-8">
        ...
        {error ? (
          ...
          >
            ...
            <p className="text-sm" style={{ color: CLR_SUBTLE }}>Notifikasi akan muncul saat ada pesanan, pembayaran, atau aktivitas toko baru.</p>
          </div>
        ) : (
                    ...
                    return (
                      ...
                      >
                        ...
                        <div
                          ...
                          style={{ background: meta.grad, boxShadow: "0 4px 10px rgba(37,99,235,0.25)" }}
                        >
                          {meta.icon}
                        </div>
