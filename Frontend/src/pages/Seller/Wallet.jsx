...
function SellerWallet() {
  ...
  const fetchWallet = async (isRefresh) => {
    try {
    ...
    <div style={{ fontFamily: FONT_BODY }}>
      ...
      <main className={`${SECTION_X} py-8`}>
        ...
        >
          ...
          <div className="relative">
            ...
            <p className="text-sm" style={{ color: CLR_MUTED }}>
              Kelola saldo dan pantau riwayat transaksi tokomu.
            </p>
          </div>
        ...
        {loading ? (
          ...
          <>
            {/* Stat cards — saldo tersedia disorot karena itu yang langsung relevan untuk aksi tarik dana */}
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-6">
              ...
              <WalletCard
                ...
                sub="Menunggu konfirmasi pembeli"
