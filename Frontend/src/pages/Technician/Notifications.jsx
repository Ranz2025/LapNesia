...
import {
  ...
  ClipboardCheck, Wrench, CreditCard, Wallet, Calendar,
...
/* ─── Notif type → icon + gradient (konteks teknisi) ─── */
const TYPE_META = {
  ...
  inspection_job_cancelled:   { icon: <XCircle size={16} />,        grad: "linear-gradient(135deg, #F87171 0%, #DC2626 100%)" },
  inspection_scheduled:       { icon: <Calendar size={16} />,       grad: "linear-gradient(135deg, #60A5FA 0%, #2563EB 100%)" },
  inspection_in_progress:     { icon: <Wrench size={16} />,         grad: "linear-gradient(135deg, #22D3EE 0%, #0891B2 100%)" },
  inspection_completed:       { icon: <CheckCircle2 size={16} />,   grad: "linear-gradient(135deg, #34D399 0%, #059669 100%)" },
  ...
  /* Pembayaran — notif utama untuk teknisi */
  inspection_payment_paid:    { icon: <CreditCard size={16} />,     grad: "linear-gradient(135deg, #34D399 0%, #059669 100%)" },
  /* Wallet / withdrawal */
  ...
  /* Verifikasi akun */
  technician_verified:        { icon: <CheckCircle2 size={16} />,   grad: "linear-gradient(135deg, #34D399 0%, #059669 100%)" },
};
      ...
      <main className="max-w-3xl mx-auto px-4 py-8">
              ...
              >
                ...
                {unreadCount > 0 && (
                  <span
                    ...
                    style={{ background: "#FB923C", border: "2px solid #1D4ED8" }}
                  />
                )}
              </div>
              <div>
                <span
                  className="inline-flex items-center gap-1.5 text-[10px] uppercase tracking-widest font-semibold mb-0.5"
        ...
        {error ? (
          ...
          >
            ...
            <p className="font-semibold mb-1" style={{ color: CLR_TEXT, fontFamily: FONT_DISPLAY }}>
              Tidak ada notifikasi
            </p>
            <p className="text-sm" style={{ color: CLR_SUBTLE }}>
              Notifikasi akan muncul saat ada job baru, pembayaran, atau aktivitas inspeksi.
            </p>
          </div>
        ) : (
                    ...
                    return (
                      <div
                        ...
                        style={{
                          ...
                          boxShadow:   isUnread
                            ? "0 4px 14px -6px rgba(37,99,235,0.18)"
                            ...
                            >
                              ...
                              {isUnread && (
                                <span
                                  ...
                                  style={{ background: CLR_ACCENT }}
                                />
                              )}
                            </h3>
                            {hasAction && (
                              <ExternalLink size={13} className="flex-shrink-0 mt-0.5" style={{ color: CLR_SUBTLE }} />
                            )}
                          </div>
